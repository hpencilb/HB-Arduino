...
void my_homekit_setup() {
    ...
    //the lamp is connected to common on of the relay so that 
    //even if homekit is down the physical button is still functional
    //and should notify homekit that the lamp is on when powered
    bool power_on_default = true;
    cha_switch_on.value.bool_value = power_on_default;
