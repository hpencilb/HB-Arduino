...
void my_homekit_report()
{
	...
	float temperature_value = event.temperature; // FIXME, read your real sensor here.
	...
	float humidity_value = event.relative_humidity; // FIXME, read your real sensor here.
